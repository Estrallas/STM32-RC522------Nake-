...
unsigned char  usart3_buf[128];
unsigned short usart3_cnt = 0;
/********GPS变量************/
char rxdatabufer;
u16 point1 = 0;
...
//	{	 	
//		if(usart3_cnt >= sizeof(usart3_buf))	usart3_cnt = 0; //防止串口被刷爆
//		usart3_buf[usart3_cnt++] = USART3->DR;
//        if(usart3_buf[usart3_cnt-1] == 'D')  //检测到蓝牙开
//        {
//          Bluetooth_flag=1;  //标志位置1
//        }   
//        if(usart3_buf[usart3_cnt-1] == 'S')  //检测到蓝牙已断开
//        {
//          Bluetooth_flag=0;  //标志位置0
//        }
